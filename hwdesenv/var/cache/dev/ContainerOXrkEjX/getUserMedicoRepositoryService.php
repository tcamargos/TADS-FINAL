...
// Returns the private 'App\Repository\UserMedicoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserMedicoRepository.php';

return $this->privates['App\\Repository\\UserMedicoRepository'] = new \App\Repository\UserMedicoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
