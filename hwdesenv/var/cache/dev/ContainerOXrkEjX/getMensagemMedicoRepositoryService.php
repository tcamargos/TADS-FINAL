...
// Returns the private 'App\Repository\MensagemMedicoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MensagemMedicoRepository.php';

return $this->privates['App\\Repository\\MensagemMedicoRepository'] = new \App\Repository\MensagemMedicoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
