...
// Returns the private 'App\Repository\MensagemEmpresaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MensagemEmpresaRepository.php';

return $this->privates['App\\Repository\\MensagemEmpresaRepository'] = new \App\Repository\MensagemEmpresaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
