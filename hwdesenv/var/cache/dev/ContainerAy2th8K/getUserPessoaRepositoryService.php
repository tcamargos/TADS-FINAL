...
// Returns the private 'App\Repository\UserPessoaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserPessoaRepository.php';

return $this->privates['App\\Repository\\UserPessoaRepository'] = new \App\Repository\UserPessoaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
