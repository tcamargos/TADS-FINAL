...
// Returns the private 'App\Repository\UserEmpresaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserEmpresaRepository.php';

return $this->privates['App\\Repository\\UserEmpresaRepository'] = new \App\Repository\UserEmpresaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
