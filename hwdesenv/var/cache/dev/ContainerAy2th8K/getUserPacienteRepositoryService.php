...
// Returns the private 'App\Repository\UserPacienteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserPacienteRepository.php';

return $this->privates['App\\Repository\\UserPacienteRepository'] = new \App\Repository\UserPacienteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
